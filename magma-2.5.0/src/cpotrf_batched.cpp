/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zpotrf_batched.cpp, normal z -> c, Sun Sep 15 17:15:21 2019
*/
...
#define dAarray(i,j)  dA_array, i, j   
    ...
    magmaFloatComplex c_neg_one = MAGMA_C_MAKE(-1.0, 0);
    magmaFloatComplex c_one     = MAGMA_C_MAKE( 1.0, 0);
    magma_device_t cdev;
    ...
    magma_queue_t queue)
{
    ...
    if (n > crossover){   
        arginfo = magma_cpotrf_lg_batched(uplo, n, dA_array, ldda, info_array, batchCount, queue);
            ...
            arginfo = magma_cpotrf_lpout_batched(uplo, n, dA_array, 0, 0, ldda, 0, info_array, batchCount, queue);
