/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zunmlq.cpp, normal z -> c, Sun Sep 15 17:13:58 2019
    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            magma_cpanel_to_q( MagmaLower, ib, A(i,i), lda, T2 );
            magma_csetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib, queue );
            magma_cq_to_panel( MagmaLower, ib, A(i,i), lda, T2 );
