/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgetrs_batched.cpp, normal z -> s, Sun Sep 15 17:15:14 2019
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if (notran) {
        ...
        if (nrhs > 1){
            ...
            // solve 
            magmablas_strsm_batched( MagmaLeft, MagmaUpper, trans, MagmaUnit, 
                    n, nrhs, MAGMA_S_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            // solve 
            magmablas_strsm_batched( MagmaLeft, MagmaLower, trans, MagmaNonUnit, 
                    n, nrhs, MAGMA_S_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            /* Solve A**T * X = B  or  A**H * X = B. */
            // solve 
            magmablas_strsv_outofplace_batched( MagmaUpper, trans, MagmaUnit, 
                n, 
                dA_array,       ldda, // dA
                dB_array,      1, // dB
                dwork_array,       // dX //output
            ...
            // solve 
            magmablas_strsv_outofplace_batched( MagmaLower, trans, MagmaNonUnit, 
                n, 
                dA_array,       ldda, // dA
                dwork_array,        1, // dB 
                dB_array,       // dX //output
