/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zbulge_back_m.cpp, normal z -> c, Sun Sep 15 17:14:40 2019
...
public:
    ...
    magma_capplyQ_m_data(magma_int_t ngpu_, magma_int_t threads_num_,
                         magma_int_t n_, magma_int_t ne_, magma_int_t n_gpu_,
                         magma_int_t nb_, magma_int_t Vblksiz_,
                         magmaFloatComplex *E_, magma_int_t lde_,
                         magmaFloatComplex *V_, magma_int_t ldv_,
                         magmaFloatComplex *TAU_,
...
/******************************************************************************/
// TODO: this is identical to function in cbulge_back.cpp
static void magma_ctile_bulge_applyQ(
    magma_int_t core_id, magma_side_t side, magma_int_t n_loc,
    magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
    magmaFloatComplex *E, magma_int_t lde,
    ...
    //, magma_int_t* info)
{
    ...
    if ((core_id == 0) || (core_id == 1))
        printf("  APPLY Q2_cpu cbulge_back_m   N %lld  N_loc %lld  nbchunk %lld  NB %lld  Vblksiz %lld  SIDE %c\n", n, n_loc, nbchunk, nb, Vblksiz, side);
    #endif
