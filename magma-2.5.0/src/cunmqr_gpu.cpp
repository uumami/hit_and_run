/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zunmqr_gpu.cpp, normal z -> c, Sun Sep 15 17:13:46 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( step < 0 ) {
        ...
        magmaFloatComplex* hA = hwork;
        magmaFloatComplex* hC = hwork + ma*ib;
    ...
    // which is async magma_gemm calls, so cunmqr can be unfinished.
