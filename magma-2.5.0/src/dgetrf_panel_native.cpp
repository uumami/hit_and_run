/*
   ...
   @generated from src/zgetrf_panel_native.cpp, normal z -> d, Sun Sep 15 17:15:32 2019
*/
...
/***************************************************************************//**
    ...
    DGETRF_PANEL computes an LU factorization of a general M-by-N matrix A
    ...
    magma_queue_t queue, magma_queue_t update_queue)
{
    ...
    if (panel_nb <= recpnb) {
        ...
        // panel on A1
        magma_dgetrf_recpanel_native(m, n1, dA(0,0), ldda, dipiv, dipivinfo, dinfo, gbstep, queue, update_queue);
