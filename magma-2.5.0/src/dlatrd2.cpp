/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zlatrd2.cpp, normal z -> d, Sun Sep 15 17:14:24 2019
        ...
        for (i = n-1; i >= n - nb; --i) {
            ...
            if (i > 0) {
                ...
                *A(i-1,i) = MAGMA_D_ONE;
                ...
                magma_dsetvector_async( i, A(0, i), 1, dA(0, i), 1, queue );
        ...
        for (i = 0; i < nb; ++i) {
            ...
            if (i < n-1) {
                ...
                *A(i+1,i) = MAGMA_D_ONE;
                ...
                magma_dsetvector_async( i_n, A(i+1, i), 1, dA(i+1, i), 1, queue );
                ...
                if (i != 0)
                    blasf77_daxpy( &i_n, &c_one, work, &ione, W(i+1, i), &ione );
