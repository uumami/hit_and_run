/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zbulge_back_m.cpp, normal z -> d, Sun Sep 15 17:14:39 2019
...
public:
    ...
    magma_dapplyQ_m_id_data()
    : id(-1), data(NULL)
    {}

    magma_dapplyQ_m_id_data(magma_int_t id_, magma_dapplyQ_m_data* data_)
    : id(id_), data(data_)
    {}
