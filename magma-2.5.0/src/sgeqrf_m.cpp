/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgeqrf_m.cpp, normal z -> s, Sun Sep 15 17:14:03 2019
    ...
    magma_int_t *info )
{
    ...
    *info = 0;
    ...
    if (m > nb && n > nb) {
        ...
        magma_ssetmatrix_1D_col_bcyclic( ngpu, m, n, nb, A, lda, da, ldda, queues );
        for( magma_int_t dev=0; dev < ngpu; dev++ ) {
            magma_setdevice( dev );
        ...
        magma_sgeqrf2_mgpu( ngpu, m, n, da, ldda, tau, info);
