/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgerfs_nopiv_gpu.cpp, normal z -> d, Sun Sep 15 17:13:15 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    Anrm = magmablas_dlange( MagmaInfNorm, n, n, dA, ldda, (magmaDouble_ptr)dworkd, n*nrhs, queue );
