/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhetrd_he2hb.cpp, normal z -> c, Sun Sep 15 17:14:33 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    lwork -= nb*nb;
    magmaFloatComplex *hT = work + lwork;
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            // because below we made a restore magma_cq_to_panel and this restore need
