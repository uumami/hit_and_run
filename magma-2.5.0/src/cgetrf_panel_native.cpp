/*
   ...
   @generated from src/zgetrf_panel_native.cpp, normal z -> c, Sun Sep 15 17:15:33 2019
*/
    ...
    magma_queue_t queue, magma_queue_t update_queue)
{
    ...
    if (panel_nb <= recpnb) {
        ...
        // panel on A1
        magma_cgetrf_recpanel_native(m, n1, dA(0,0), ldda, dipiv, dipivinfo, dinfo, gbstep, queue, update_queue);
        ...
        // panel on A2
        magma_cgetrf_recpanel_native(m-n1, n2, dA(n1,n1), ldda, dipiv+n1, dipivinfo+n1, dinfo, n1, queue, update_queue);
