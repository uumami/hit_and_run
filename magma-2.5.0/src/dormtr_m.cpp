/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zunmtr_m.cpp, normal z -> d, Sun Sep 15 17:14:31 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        //magma_dormql_m(ngpu, side, trans, mi, ni, i__2, A(0,1), lda, tau,
        ...
        i__2 = nq - 1;
        magma_dormqr_m(ngpu, side, trans, mi, ni, i__2, A(1,0), lda, tau,
