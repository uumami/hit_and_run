/*
   ...
   @generated from src/zgetrf_panel_nopiv_batched.cpp, normal z -> d, Sun Sep 15 17:15:12 2019
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if ((m-nb) > 0) {
        ...
        magmablas_dtrsm_inv_work_batched( MagmaRight, MagmaUpper, MagmaNoTrans, MagmaNonUnit,
                              1, m-nb, nb, 
                              MAGMA_D_ONE,
                              dA_array,    ldda, 
                              dW0_displ,   ldda, 
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if (panel_nb <= min_recpnb) {
        ...
        magmablas_dtrsm_inv_work_batched( MagmaLeft, MagmaLower, MagmaNoTrans, MagmaUnit, 1,
                              n1, n2,
                              MAGMA_D_ONE,
                              dA_displ,    ldda, // dA
                              dW5_displ,   ldda, // dB
        ...
        magma_dgemm_batched( MagmaNoTrans, MagmaNoTrans, m2, n2, n1, 
