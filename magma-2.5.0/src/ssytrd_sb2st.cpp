/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhetrd_hb2st.cpp, normal z -> s, Sun Sep 15 17:14:33 2019
    ...
    volatile magma_int_t* prog)
{
    ...
    pthread_barrier_init(&(sbulge_data_S->myptbarrier), NULL, (unsigned) sbulge_data_S->threads_num);
}
