/*
   ...
   @generated from src/zgetrf_panel_batched.cpp, normal z -> c, Sun Sep 15 17:15:11 2019
*/
...
#define ipiv_array(i)   dipiv_array, i
    ...
    if (n <= min_recpnb) {
        ...
        magma_cgemm_batched_core( 
                ...
                m-n1, n2, n1, 
                MAGMA_C_NEG_ONE, dAarray(ai+n1,    aj), ldda, 
                                 dAarray(ai   , aj+n1), ldda, 
                MAGMA_C_ONE,     dAarray(ai+n1, aj+n1), ldda, 
                batchCount, queue );
