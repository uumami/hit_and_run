/*
   ...
   @generated from src/zgetrf_nopiv_batched.cpp, normal z -> d, Sun Sep 15 17:15:14 2019
 */
...
#define dAarray(i_, j_)    dA_array, i_, j_
    ...
    for (i = 0; i < min_mn; i += nb) 
    {
        ...
        magma_dgetf2_nopiv_batched(pm, ib, dAarray(i,i), ldda, info_array, i, batchCount, queue);
        ...
        if ( (i + ib) < n){
            ...
            if ( (i + ib) < m){    
                magma_dgemm_batched_core( MagmaNoTrans, MagmaNoTrans, m-i-ib, n-i-ib, ib, 
