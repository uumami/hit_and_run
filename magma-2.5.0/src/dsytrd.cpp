/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhetrd.cpp, normal z -> d, Sun Sep 15 17:14:22 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    #endif
    if (MAGMA_SUCCESS != magma_dmalloc( &dA, ldda*n + 2*lddw*nb + ldwork2 )) {
        magma_free_cpu( work2 );
        *info = MAGMA_ERR_DEVICE_ALLOC;
        return *info;
    }

    double *dwork  = dA + ldda*n;
    #ifdef FAST_HEMV
    ...
    if (upper) {
        ...
        magma_dsetmatrix( n, n, A(0, 0), lda, dA(0, 0), ldda, queue );
