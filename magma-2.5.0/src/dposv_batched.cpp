/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zposv_batched.cpp, normal z -> d, Sun Sep 15 17:15:24 2019
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    info = magma_dpotrf_batched( uplo, n, dA_array, ldda, dinfo_array, batchCount, queue);
    ...
    {
        if (cpu_info[i] != 0 ) {
            printf("magma_dpotrf_batched matrix %lld returned error %lld\n",
    ...
    info = magma_dpotrs_batched( uplo, n, nrhs, dA_array, ldda, dB_array, lddb,  batchCount, queue );
    return info;
}
