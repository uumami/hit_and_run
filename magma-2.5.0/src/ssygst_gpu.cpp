/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhegst_gpu.cpp, normal z -> s, Sun Sep 15 17:14:47 2019
*/
...
/***************************************************************************//**
    ...
    @param[in,out]
    dA      REAL array, on the GPU device, dimension (LDDA,N)
    ...
    @param[in]
    dB      REAL array, on the GPU device, dimension (LDDB,N)
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_SUCCESS != magma_smalloc_pinned( &work, 2*nb*nb )) {
