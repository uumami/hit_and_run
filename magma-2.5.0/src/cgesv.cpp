/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgesv.cpp, normal z -> c, Sun Sep 15 17:13:25 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_cgetrf_gpu( n, n, dA(0,0), ldda, ipiv, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_cgetrs_gpu( MagmaNoTrans, n, nrhs, dA(0,0), ldda, ipiv, dB(0,0), lddb, info );
