/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zunmlq.cpp, normal z -> d, Sun Sep 15 17:13:58 2019
    ...
    if (nb >= k) {
        ...
        for (i = i1; (step < 0 ? i >= i2 : i < i2); i += step) {
            ...
            /* 1) set upper triangle of panel in A to identity,
               ...
               3) restore A                                      */
            magma_dpanel_to_q( MagmaLower, ib, A(i,i), lda, T2 );
            magma_dsetmatrix( ib, nq_i,  A(i,i), lda, dV(0,0), ib, queue );
            magma_dq_to_panel( MagmaLower, ib, A(i,i), lda, T2 );
