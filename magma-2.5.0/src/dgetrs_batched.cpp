/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgetrs_batched.cpp, normal z -> d, Sun Sep 15 17:15:14 2019
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if (notran) {
        ...
        if (nrhs > 1){
            ...
            magmablas_dtrsm_batched( MagmaLeft, MagmaLower, MagmaNoTrans, MagmaUnit, 
                    n, nrhs, MAGMA_D_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            // solve X = U^-1 * dwork
            magmablas_dtrsm_batched( MagmaLeft, MagmaUpper, MagmaNoTrans, MagmaNonUnit, 
                    n, nrhs, MAGMA_D_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            // solve dwork = L^-1 * 1
            magmablas_dtrsv_outofplace_batched( MagmaLower, MagmaNoTrans, MagmaUnit,
                n, 
                dA_array,       ldda, // dA
                dB_array,        1, // dB
        ...
        if (nrhs > 1){
            ...
            // solve 
            magmablas_dtrsm_batched( MagmaLeft, MagmaUpper, trans, MagmaUnit, 
                    n, nrhs, MAGMA_D_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            // solve 
            magmablas_dtrsm_batched( MagmaLeft, MagmaLower, trans, MagmaNonUnit, 
                    n, nrhs, MAGMA_D_ONE, 
                    dA_array, ldda, 
                    dB_array, lddb, 
                    batchCount, queue);
            ...
            /* Solve A**T * X = B  or  A**H * X = B. */
            // solve 
            magmablas_dtrsv_outofplace_batched( MagmaUpper, trans, MagmaUnit, 
                n, 
                dA_array,       ldda, // dA
                dB_array,      1, // dB
                dwork_array,       // dX //output
            ...
            // solve 
            magmablas_dtrsv_outofplace_batched( MagmaLower, trans, MagmaNonUnit, 
                n, 
                dA_array,       ldda, // dA
                dwork_array,        1, // dB 
                dB_array,       // dX //output
