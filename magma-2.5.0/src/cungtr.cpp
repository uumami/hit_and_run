/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zungtr.cpp, normal z -> c, Sun Sep 15 17:14:25 2019
...
/***************************************************************************//**
    ...
    dT      COMPLEX array on the GPU device.
            ...
            reflectors H(i) as returned by magma_chetrd.
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (j = 0; j < n-1; ++j) {
            ...
            *A(n-1, j) = MAGMA_C_ZERO;
        }
        for (i = 0; i < n-1; ++i) {
            *A(i, n-1) = MAGMA_C_ZERO;
        }
        *A(n-1, n-1) = MAGMA_C_ONE;
        ...
        *A(0, 0) = MAGMA_C_ONE;
        ...
        if (n > 1) {
            /* Generate Q(2:n,2:n) */
            magma_cungqr(n-1, n-1, n-1, A(1, 1), lda, tau, dT, nb, &iinfo);
        }
    }
