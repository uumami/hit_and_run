/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zlarfb_gemm_batched.cpp, normal z -> s, Sun Sep 15 17:15:25 2019
*/
    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if ( side == MagmaLeft ) {
        ...
        if (m <= n) {
            // W2 = V T
            magma_sgemm_batched( notransV, trans, /* (NoTrans), trans(ConjTrans),*/
                         m, k, k,
                         c_one,  dV_array, lddv,
                                 dT_array, lddt,
        ...
        // W = C V
        magma_sgemm_batched( MagmaNoTrans, notransV,
                     m, k, n,
                     c_one,  dC_array,    lddc,
                             dV_array,    lddv,
                     c_zero, dwork_array, ldw,
