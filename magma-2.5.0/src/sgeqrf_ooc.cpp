/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgeqrf_ooc.cpp, normal z -> s, Sun Sep 15 17:13:53 2019
    ...
    *info = 0;
    ...
    for (i=0; i < n; i += NB) {
        ...
        for (j=0; j < min(i,min_mn); j += nb) {
            ...
            magma_spanel_to_q( MagmaUpper, ib, A(j,j), lda, work+ib*ib );
            ...
            magma_sq_to_panel( MagmaUpper, ib, A(j,j), lda, work+ib*ib );
        }
