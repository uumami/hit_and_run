/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zlatrd_mgpu.cpp, normal z -> d, Sun Sep 15 17:14:29 2019
...
/***************************************************************************//**
    ...
    @param
    dA      DOUBLE PRECISION array of pointers on the GPU, dimension (ngpu)
    ...
    @param
    dW      DOUBLE PRECISION array on the GPU, dimension (ngpu*lddw*(3*nb)).
