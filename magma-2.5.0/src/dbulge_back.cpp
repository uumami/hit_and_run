/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zbulge_back.cpp, normal z -> d, Sun Sep 15 17:14:35 2019
...
void magma_dapplyQ_data_init(
    magma_dapplyQ_data *zapplyQ_data, magma_int_t threads_num,
    ...
    magma_int_t* info)
{
    ...
    if (n_gpu < ne) {
        ...
        magma_dsetmatrix( n, ne-n_gpu, Z + n_gpu*ldz, ldz, dZ + n_gpu*ldz, lddz, queue );

        /*============================
         *  use only GPU
         *==========================*/
    } else {
        magma_dsetmatrix( n, ne, Z, ldz, dZ, lddz, queue );
...
static void *magma_dapplyQ_parallel_section(void *arg)
{
    ...
    if (my_core_id == 0) {
        ...
        magma_dsetmatrix( n, n_gpu, E, lde, dE, ldde, queue );
...
/******************************************************************************/
// TODO: this is identical to function in dbulge_back_m.cpp
static void magma_dtile_bulge_applyQ(
    magma_int_t core_id, magma_side_t side, magma_int_t n_loc,
    magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
    double *E, magma_int_t lde,
    ...
    //, magma_int_t* info)
{
    ...
    if ((core_id == 0) || (core_id == 1))
        printf("  APPLY Q2_cpu dbulge_back   N %lld  N_loc %lld  nbchunk %lld  NB %lld  Vblksiz %lld  SIDE %c\n", n, n_loc, nbchunk, nb, Vblksiz, side);
    #endif
