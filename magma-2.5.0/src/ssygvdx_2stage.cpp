/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhegvdx_2stage.cpp, normal z -> s, Sun Sep 15 17:14:37 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_ssyevdx_2stage( jobz, range, uplo, n, A, lda, vl, vu, il, iu, mout, w,
                          work, lwork,
                          #ifdef COMPLEX
                          rwork, lrwork,
                          #endif
    ...
    if (wantz && *info == 0) {
        ...
        magma_ssetmatrix( n, *mout, A, lda, dA, ldda, queues[0] );
        magma_ssetmatrix( n,  n,    B, ldb, dB, lddb, queues[0] );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_strsm( MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda, queues[0] );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_strmm( MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda, queues[0] );
        }

        magma_sgetmatrix( n, *mout, dA, ldda, A, lda, queues[0] );
