/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zpotrf_m.cpp, normal z -> c, Sun Sep 15 17:13:14 2019
...
#define dTup(d, i, j) (   dt[(d)] + (j)*nb    + (i))
    ...
    *info = 0;
    ...
    for (d=0; d < ngpu; d++ ) {
        magma_setdevice(d);
        if (MAGMA_SUCCESS != magma_cmalloc( &dt[d], NB*lddla + max(2,ngpu)*nb*ldda )) {
    ...
    if (upper) {
        ...
        for( J=0; J < n; J += NB ) {
            ...
            magma_chtodpo( ngpu, uplo, JB, n, J, J, nb, A, lda, dwork, NB, queues, &iinfo);
            ...
            magma_cdtohpo(ngpu, uplo, JB, n, J, J, nb, NB, A, lda, dwork, NB, queues, &iinfo);
            //magma_cdtohpo(ngpu, uplo, JB, n, J, J, nb, 0, A, lda, dwork, NB, queues, &iinfo);
        }
    } else {
        /* ========================================================= *
        ...
        for( J=0; J < n; J += NB ) {
            ...
            magma_chtodpo( ngpu, uplo, n, JB, J, J, nb, A, lda, dwork, lddla, queues, &iinfo);
            ...
            magma_cdtohpo( ngpu, uplo, n, JB, J, J, nb, JB, A, lda, dwork, lddla, queues, &iinfo);
        } /* end of for J */
    } /* if upper */
    } /* if nb */
