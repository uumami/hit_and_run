/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhegvdx.cpp, normal z -> c, Sun Sep 15 17:14:46 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    timer_start( time );
    magma_cheevdx_gpu( jobz, range, uplo, n, dA, ldda, vl, vu, il, iu, mout, w, A, lda,
                       work, lwork, rwork, lrwork, iwork, liwork, info );
    timer_stop( time );
    timer_printf( "time cheevdx_gpu = %6.2f\n", time );
    ...
    if (wantz && *info == 0) {
        ...
        magma_cgetmatrix( n, *mout, dA, ldda, A, lda, queue );
