/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgeqrf_batched.cpp, normal z -> d, Sun Sep 15 17:15:27 2019
*/
    ...
    magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue)
{
    ...
    if( m == n && m <= 32 ){
        return magma_dgeqrf_batched_smallsq( m, dA_array, ldda, dtau_array, info_array, batchCount, queue );
    }
    ...
    double *dT        = NULL;
    double *dR        = NULL;
    double **dR_array = NULL;
    double **dT_array = NULL;
    ...
    magma_dmalloc(&dR,  lddr * lddr * batchCount);
    magma_dmalloc(&dT,  lddt * lddt * batchCount);
