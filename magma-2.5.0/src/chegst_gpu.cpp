/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhegst_gpu.cpp, normal z -> c, Sun Sep 15 17:14:48 2019
*/
...
/***************************************************************************//**
    ...
    @param[in,out]
    dA      COMPLEX array, on the GPU device, dimension (LDDA,N)
    ...
    @param[in]
    dB      COMPLEX array, on the GPU device, dimension (LDDB,N)
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (MAGMA_SUCCESS != magma_cmalloc_pinned( &work, 2*nb*nb )) {
