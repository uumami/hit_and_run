/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgeqp3_gpu.cpp, normal z -> d, Sun Sep 15 17:13:47 2019
    ...
    magma_int_t *info )
{
    ...
    *info = 0;
    ...
    magmablas_dlaset( MagmaFull, n+1, nb, c_zero, c_zero, df, n+1, queue );
    ...
    if (nfxd < minmn) {
        ...
        magmablas_dnrm2_cols( sm, sn, dA(nfxd,nfxd), ldda, &rwork[nfxd], queue );
