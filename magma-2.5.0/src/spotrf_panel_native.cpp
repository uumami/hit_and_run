/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zpotrf_panel_native.cpp, normal z -> s, Sun Sep 15 17:15:33 2019
*/
...
/***************************************************************************//**
    Purpose
    -------
    SPOTRF_RECTILE computes the Cholesky factorization of a real symmetric
    ...
    magma_int_t *dinfo,  magma_int_t *info, magma_queue_t queue)
{
    ...
    *info = 0;
    ...
    if (n <= recnb) {
        ...
        //  panel factorization
        //magma_spotf2_lpout(MagmaLower, n, dA, ldda, gbstep, dinfo, queue );
        magma_spotf2_lpin(MagmaLower, n, dA, ldda, gbstep, dinfo, queue );
        //magma_spotf2_native(MagmaLower, n, dA, ldda, gbstep, dinfo, queue );
    }
    else {
        ...
        magma_spotrf_rectile_native( uplo, n1, recnb, 
                                     dA(p1, p1), ldda, 
