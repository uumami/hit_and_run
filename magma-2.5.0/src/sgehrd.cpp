/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zgehrd.cpp, normal z -> s, Sun Sep 15 17:14:54 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb == 1 || nb > nh) {
        ...
        magmablas_slaset( MagmaFull, nb, n, c_zero, c_zero, dT(0,0), nb, queue );
        ...
        for (i = ilo; i < ihi-1 - nb; i += nb) {
            ...
            magma_ssetmatrix( nb, nb, T, nb, dT(0,i-ilo), nb, queue );
