    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_csetmatrix( n, n, B, ldb, dB, lddb, queues[0] );
    ...
    magma_cgetmatrix( n, n, dA, ldda, A, lda, queues[0] );
    ...
    if (wantz && *info == 0) {
        ...
        magma_csetmatrix( n, *mout, A, lda, dA, ldda, queues[0] );
        magma_csetmatrix( n,  n,    B, ldb, dB, lddb, queues[0] );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_ctrsm( MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda, queues[0] );
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_ctrmm( MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda, queues[0] );
        }

        magma_cgetmatrix( n, *mout, dA, ldda, A, lda, queues[0] );
