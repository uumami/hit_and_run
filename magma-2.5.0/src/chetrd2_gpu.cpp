/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zhetrd2_gpu.cpp, normal z -> c, Sun Sep 15 17:14:18 2019
...
/***************************************************************************//**
    ...
    ldwork  INTEGER
            ...
            LDWORK >= ldda*ceil(n/64) + 2*ldda*nb, where nb = magma_get_chetrd_nb(n),
            and 64 is for the blocksize of magmablas_chemv.
