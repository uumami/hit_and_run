/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zlatrd_mgpu.cpp, normal z -> c, Sun Sep 15 17:14:29 2019
...
/***************************************************************************//**
    ...
    nb0     INTEGER
            ...
            nb and nb0 can be different for the final step of chetrd.
    ...
    @param
    dA      COMPLEX array of pointers on the GPU, dimension (ngpu)
    ...
    @param
    dW      COMPLEX array on the GPU, dimension (ngpu*lddw*(3*nb)).
