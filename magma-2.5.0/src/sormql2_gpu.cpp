/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from src/zunmql2_gpu.cpp, normal z -> s, Sun Sep 15 17:13:43 2019
...
/***************************************************************************//**
    ...
    dA      REAL array on the GPU, dimension (LDDA,K)
            ...
            SGEQLF in the last k columns of its array argument dA.
    ...
    magma_int_t *info)
{
    ...
    *info  = 0;
    ...
    magmablas_slaset_band( MagmaLower, k, k, nb, c_zero, c_one, dA(nq-k,0), ldda, queue );
