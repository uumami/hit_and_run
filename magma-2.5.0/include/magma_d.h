/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from include/magma_z.h, normal z -> d, Sun Sep 15 17:12:09 2019
*/
...
magma_dgetrf2_mgpu(
    ...
    magmaDouble_ptr d_lAT[], magma_int_t lddat,
    magma_int_t *ipiv,
...
void magma_dpanel_to_q(
    magma_uplo_t uplo, magma_int_t ib,
    double *A, magma_int_t lda,
    double *work);

void magma_dq_to_panel(
    magma_uplo_t uplo, magma_int_t ib,
    double *A, magma_int_t lda,
    double *work);
