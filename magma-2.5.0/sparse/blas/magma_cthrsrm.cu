/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/magma_zthrsrm.cu, normal z -> c, Sun Sep 15 17:34:43 2019
       @author Hartwig Anzt
    ...
    magma_queue_t queue)
{
    ...
    magma_cget_row_ptr(A->num_rows, &B.nnz, new_rownnz, B.drow, queue); 
    magma_cmalloc(&B.dval,B.nnz);
