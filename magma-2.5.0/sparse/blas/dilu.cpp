/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/zilu.cpp, normal z -> d, Sun Sep 15 17:34:20 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    if( precond->trisolver == Magma_CUSOLVE || precond->trisolver == 0 ){
        ...
        CHECK_CUSPARSE( cusparseDcsrsm_analysis( cusparseHandle,
            ...
            CHECK_CUSPARSE(cusparseDcsr2csc(cusparseHandle, hL.num_cols, 
                             hL.num_rows, hL.nnz,
            ...
            // conversion using CUSPARSE
            CHECK_CUSPARSE(cusparseDcsr2csc(cusparseHandle, hU.num_cols, 
                             hU.num_rows, hU.nnz,
