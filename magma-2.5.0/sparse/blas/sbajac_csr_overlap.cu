/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/zbajac_csr_overlap.cu, normal z -> s, Sun Sep 15 17:31:59 2019
...
__global__ void magma_sk_testLocking(unsigned int* locks, int n) {
...
/*
__global__ void
magma_sbajac_csr_o_ls_kernel(int localiters, int n, 
                             int matrices, int overlap, 
                             magma_s_matrix *D, magma_s_matrix *R,
...
__global__ void
magma_sbajac_csr_o_ls_kernel1(int localiters, int n, 
                             int matrices, int overlap, 
                            float * valD, 
                            magma_index_t * rowD, 
                            magma_index_t * colD, 
...
__global__ void
magma_sbajac_csr_o_ls_kernel2(int localiters, int n, 
                             int matrices, int overlap, 
                            float * valD0, 
                            magma_index_t * rowD0, 
                            magma_index_t * colD0, 
...
__global__ void
magma_sbajac_csr_o_ls_kernel4(int localiters, int n, 
                             int matrices, int overlap, 
                            float * valD0, magma_index_t * rowD0, magma_index_t * colD0, float * valR0, magma_index_t * rowR0, magma_index_t * colR0, 
                            float * valD1, magma_index_t * rowD1, magma_index_t * colD1, float * valR1, magma_index_t * rowR1, magma_index_t * colR1, 
                            float * valD2, magma_index_t * rowD2, magma_index_t * colD2, float * valR2, magma_index_t * rowR2, magma_index_t * colR2, 
                            float * valD3, magma_index_t * rowD3, magma_index_t * colD3, float * valR3, magma_index_t * rowR3, magma_index_t * colR3, 
                            const float *  __restrict__ b,                            
                            float * x )
{
    int inddiag =  blockIdx.x*(blockDim.x - overlap) - overlap;
...
__global__ void
magma_sbajac_csr_o_ls_kernel8(int localiters, int n, 
                             int matrices, int overlap, 
                            float * valD0, magma_index_t * rowD0, magma_index_t * colD0, float * valR0, magma_index_t * rowR0, magma_index_t * colR0, 
                            float * valD1, magma_index_t * rowD1, magma_index_t * colD1, float * valR1, magma_index_t * rowR1, magma_index_t * colR1, 
                            float * valD2, magma_index_t * rowD2, magma_index_t * colD2, float * valR2, magma_index_t * rowR2, magma_index_t * colR2, 
                            float * valD3, magma_index_t * rowD3, magma_index_t * colD3, float * valR3, magma_index_t * rowR3, magma_index_t * colR3, 
                            float * valD4, magma_index_t * rowD4, magma_index_t * colD4, float * valR4, magma_index_t * rowR4, magma_index_t * colR4, 
                            float * valD5, magma_index_t * rowD5, magma_index_t * colD5, float * valR5, magma_index_t * rowR5, magma_index_t * colR5, 
                            float * valD6, magma_index_t * rowD6, magma_index_t * colD6, float * valR6, magma_index_t * rowR6, magma_index_t * colR6, 
                            float * valD7, magma_index_t * rowD7, magma_index_t * colD7, float * valR7, magma_index_t * rowR7, magma_index_t * colR7, 
                            const float *  __restrict__ b,                            
                            float * x )
{
    int inddiag =  blockIdx.x*(blockDim.x - overlap) - overlap;
...
__global__ void
magma_sbajac_csr_o_ls_kernel16(int localiters, int n, 
                             int matrices, int overlap, 
                            float *valD0 , magma_index_t *rowD0 , magma_index_t *colD0 , float *valR0 , magma_index_t *rowR0 , magma_index_t *colR0 , 
                            float *valD1 , magma_index_t *rowD1 , magma_index_t *colD1 , float *valR1 , magma_index_t *rowR1 , magma_index_t *colR1 , 
                            float *valD2 , magma_index_t *rowD2 , magma_index_t *colD2 , float *valR2 , magma_index_t *rowR2 , magma_index_t *colR2 , 
                            ...
                            float *valD6 , magma_index_t *rowD6 , magma_index_t *colD6 , float *valR6 , magma_index_t *rowR6 , magma_index_t *colR6 , 
                            float *valD7 , magma_index_t *rowD7 , magma_index_t *colD7 , float *valR7 , magma_index_t *rowR7 , magma_index_t *colR7 , 
                            float *valD8 , magma_index_t *rowD8 , magma_index_t *colD8 , float *valR8 , magma_index_t *rowR8 , magma_index_t *colR8 , 
                            float *valD9 , magma_index_t *rowD9 , magma_index_t *colD9 , float *valR9 , magma_index_t *rowR9 , magma_index_t *colR9 , 
                            float *valD10, magma_index_t *rowD10, magma_index_t *colD10, float *valR10, magma_index_t *rowR10, magma_index_t *colR10,
                            float *valD11, magma_index_t *rowD11, magma_index_t *colD11, float *valR11, magma_index_t *rowR11, magma_index_t *colR11,
                            float *valD12, magma_index_t *rowD12, magma_index_t *colD12, float *valR12, magma_index_t *rowR12, magma_index_t *colR12, 
                            float *valD13, magma_index_t *rowD13, magma_index_t *colD13, float *valR13, magma_index_t *rowR13, magma_index_t *colR13, 
                            float *valD14, magma_index_t *rowD14, magma_index_t *colD14, float *valR14, magma_index_t *rowR14, magma_index_t *colR14, 
                            float *valD15, magma_index_t *rowD15, magma_index_t *colD15, float *valR15, magma_index_t *rowR15, magma_index_t *colR15,  
                            const float *  __restrict__ b,                            
                            float * x )
{
    int inddiag =  blockIdx.x*(blockDim.x - overlap) - overlap;
...
__global__ void
magma_sbajac_csr_o_ls_kernel32(int localiters, int n, 
                             int matrices, int overlap, 
                            float *valD0 , magma_index_t *rowD0 , magma_index_t *colD0 , float *valR0 , magma_index_t *rowR0 , magma_index_t *colR0 , 
                            float *valD1 , magma_index_t *rowD1 , magma_index_t *colD1 , float *valR1 , magma_index_t *rowR1 , magma_index_t *colR1 , 
                            float *valD2 , magma_index_t *rowD2 , magma_index_t *colD2 , float *valR2 , magma_index_t *rowR2 , magma_index_t *colR2 , 
                            ...
                            float *valD14, magma_index_t *rowD14, magma_index_t *colD14, float *valR14, magma_index_t *rowR14, magma_index_t *colR14, 
                            float *valD15, magma_index_t *rowD15, magma_index_t *colD15, float *valR15, magma_index_t *rowR15, magma_index_t *colR15, 
                            float *valD16, magma_index_t *rowD16, magma_index_t *colD16, float *valR16, magma_index_t *rowR16, magma_index_t *colR16, 
                            float *valD17, magma_index_t *rowD17, magma_index_t *colD17, float *valR17, magma_index_t *rowR17, magma_index_t *colR17, 
                            float *valD18, magma_index_t *rowD18, magma_index_t *colD18, float *valR18, magma_index_t *rowR18, magma_index_t *colR18, 
                            float *valD19, magma_index_t *rowD19, magma_index_t *colD19, float *valR19, magma_index_t *rowR19, magma_index_t *colR19, 
                            float *valD20, magma_index_t *rowD20, magma_index_t *colD20, float *valR20, magma_index_t *rowR20, magma_index_t *colR20, 
                            float *valD21, magma_index_t *rowD21, magma_index_t *colD21, float *valR21, magma_index_t *rowR21, magma_index_t *colR21, 
                            float *valD22, magma_index_t *rowD22, magma_index_t *colD22, float *valR22, magma_index_t *rowR22, magma_index_t *colR22, 
                            float *valD23, magma_index_t *rowD23, magma_index_t *colD23, float *valR23, magma_index_t *rowR23, magma_index_t *colR23, 
                            float *valD24, magma_index_t *rowD24, magma_index_t *colD24, float *valR24, magma_index_t *rowR24, magma_index_t *colR24, 
                            float *valD25, magma_index_t *rowD25, magma_index_t *colD25, float *valR25, magma_index_t *rowR25, magma_index_t *colR25, 
                            float *valD26, magma_index_t *rowD26, magma_index_t *colD26, float *valR26, magma_index_t *rowR26, magma_index_t *colR26, 
                            float *valD27, magma_index_t *rowD27, magma_index_t *colD27, float *valR27, magma_index_t *rowR27, magma_index_t *colR27, 
                            float *valD28, magma_index_t *rowD28, magma_index_t *colD28, float *valR28, magma_index_t *rowR28, magma_index_t *colR28, 
                            float *valD29, magma_index_t *rowD29, magma_index_t *colD29, float *valR29, magma_index_t *rowR29, magma_index_t *colR29, 
                            float *valD30, magma_index_t *rowD30, magma_index_t *colD30, float *valR30, magma_index_t *rowR30, magma_index_t *colR30, 
                            float *valD31, magma_index_t *rowD31, magma_index_t *colD31, float *valR31, magma_index_t *rowR31, magma_index_t *colR31, 
                            const float *  __restrict__ b,                            
                            float * x )
{
    int inddiag =  blockIdx.x*(blockDim.x - overlap) - overlap;
...
__global__ void
magma_sbajac_csr_o_ls_kernel64(int localiters, int n, 
                             int matrices, int overlap, 
                            float *valD0 , magma_index_t *rowD0 , magma_index_t *colD0 , float *valR0 , magma_index_t *rowR0 , magma_index_t *colR0 , 
                            float *valD1 , magma_index_t *rowD1 , magma_index_t *colD1 , float *valR1 , magma_index_t *rowR1 , magma_index_t *colR1 , 
                            float *valD2 , magma_index_t *rowD2 , magma_index_t *colD2 , float *valR2 , magma_index_t *rowR2 , magma_index_t *colR2 , 
                            ...
                            float *valD30, magma_index_t *rowD30, magma_index_t *colD30, float *valR30, magma_index_t *rowR30, magma_index_t *colR30, 
                            float *valD31, magma_index_t *rowD31, magma_index_t *colD31, float *valR31, magma_index_t *rowR31, magma_index_t *colR31, 
                            float *valD32, magma_index_t *rowD32, magma_index_t *colD32, float *valR32, magma_index_t *rowR32, magma_index_t *colR32, 
                            float *valD33, magma_index_t *rowD33, magma_index_t *colD33, float *valR33, magma_index_t *rowR33, magma_index_t *colR33, 
                            float *valD34, magma_index_t *rowD34, magma_index_t *colD34, float *valR34, magma_index_t *rowR34, magma_index_t *colR34, 
                            float *valD35, magma_index_t *rowD35, magma_index_t *colD35, float *valR35, magma_index_t *rowR35, magma_index_t *colR35, 
                            float *valD36, magma_index_t *rowD36, magma_index_t *colD36, float *valR36, magma_index_t *rowR36, magma_index_t *colR36, 
                            float *valD37, magma_index_t *rowD37, magma_index_t *colD37, float *valR37, magma_index_t *rowR37, magma_index_t *colR37, 
                            float *valD38, magma_index_t *rowD38, magma_index_t *colD38, float *valR38, magma_index_t *rowR38, magma_index_t *colR38, 
                            float *valD39, magma_index_t *rowD39, magma_index_t *colD39, float *valR39, magma_index_t *rowR39, magma_index_t *colR39, 
                            float *valD40, magma_index_t *rowD40, magma_index_t *colD40, float *valR40, magma_index_t *rowR40, magma_index_t *colR40, 
                            float *valD41, magma_index_t *rowD41, magma_index_t *colD41, float *valR41, magma_index_t *rowR41, magma_index_t *colR41, 
                            float *valD42, magma_index_t *rowD42, magma_index_t *colD42, float *valR42, magma_index_t *rowR42, magma_index_t *colR42, 
                            float *valD43, magma_index_t *rowD43, magma_index_t *colD43, float *valR43, magma_index_t *rowR43, magma_index_t *colR43, 
                            float *valD44, magma_index_t *rowD44, magma_index_t *colD44, float *valR44, magma_index_t *rowR44, magma_index_t *colR44, 
                            float *valD45, magma_index_t *rowD45, magma_index_t *colD45, float *valR45, magma_index_t *rowR45, magma_index_t *colR45, 
                            float *valD46, magma_index_t *rowD46, magma_index_t *colD46, float *valR46, magma_index_t *rowR46, magma_index_t *colR46, 
                            float *valD47, magma_index_t *rowD47, magma_index_t *colD47, float *valR47, magma_index_t *rowR47, magma_index_t *colR47, 
                            float *valD48, magma_index_t *rowD48, magma_index_t *colD48, float *valR48, magma_index_t *rowR48, magma_index_t *colR48, 
                            float *valD49, magma_index_t *rowD49, magma_index_t *colD49, float *valR49, magma_index_t *rowR49, magma_index_t *colR49, 
                            float *valD50, magma_index_t *rowD50, magma_index_t *colD50, float *valR50, magma_index_t *rowR50, magma_index_t *colR50,
                            float *valD51, magma_index_t *rowD51, magma_index_t *colD51, float *valR51, magma_index_t *rowR51, magma_index_t *colR51,
                            float *valD52, magma_index_t *rowD52, magma_index_t *colD52, float *valR52, magma_index_t *rowR52, magma_index_t *colR52, 
                            float *valD53, magma_index_t *rowD53, magma_index_t *colD53, float *valR53, magma_index_t *rowR53, magma_index_t *colR53, 
                            float *valD54, magma_index_t *rowD54, magma_index_t *colD54, float *valR54, magma_index_t *rowR54, magma_index_t *colR54, 
                            float *valD55, magma_index_t *rowD55, magma_index_t *colD55, float *valR55, magma_index_t *rowR55, magma_index_t *colR55, 
                            float *valD56, magma_index_t *rowD56, magma_index_t *colD56, float *valR56, magma_index_t *rowR56, magma_index_t *colR56, 
                            float *valD57, magma_index_t *rowD57, magma_index_t *colD57, float *valR57, magma_index_t *rowR57, magma_index_t *colR57, 
                            float *valD58, magma_index_t *rowD58, magma_index_t *colD58, float *valR58, magma_index_t *rowR58, magma_index_t *colR58, 
                            float *valD59, magma_index_t *rowD59, magma_index_t *colD59, float *valR59, magma_index_t *rowR59, magma_index_t *colR59, 
                            float *valD60, magma_index_t *rowD60, magma_index_t *colD60, float *valR60, magma_index_t *rowR60, magma_index_t *colR60, 
                            float *valD61, magma_index_t *rowD61, magma_index_t *colD61, float *valR61, magma_index_t *rowR61, magma_index_t *colR61, 
                            float *valD62, magma_index_t *rowD62, magma_index_t *colD62, float *valR62, magma_index_t *rowR62, magma_index_t *colR62, 
                            float *valD63, magma_index_t *rowD63, magma_index_t *colD63, float *valR63, magma_index_t *rowR63, magma_index_t *colR63, 
                            const float *  __restrict__ b,                            
                            float * x )
{
    int inddiag =  blockIdx.x*(blockDim.x - overlap) - overlap;
    ...
    magma_queue_t queue )
{
    ...
    if ( min_nnz > -1 ){ 
        if ( matrices == 1 ){
            ...
            magma_sbajac_csr_o_ls_kernel1<<< grid, block, 0, queue->cuda_stream() >>>
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel2<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel4<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
                    D[1].dval, D[1].drow, D[1].dcol, R[1].dval, R[1].drow, R[1].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel8<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[0].dval, D[0].drow, D[0].dcol, R[0].dval, R[0].drow, R[0].dcol, 
                    D[1].dval, D[1].drow, D[1].dcol, R[1].dval, R[1].drow, R[1].dcol,
                    D[2].dval, D[2].drow, D[2].dcol, R[2].dval, R[2].drow, R[2].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel16<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel32<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
            ...
            dim3 grid( dimgrid1, dimgrid2, dimgrid3 );
            dim3 block( blocksize1, blocksize2, 1 );
            magma_sbajac_csr_o_ls_kernel64<<< grid, block, 0, queue->cuda_stream() >>>
                ( localiters, size, matrices, overlap,
                    D[ 0].dval, D[ 0].drow, D[ 0].dcol, R[ 0].dval, R[ 0].drow, R[ 0].dcol, 
                    D[ 1].dval, D[ 1].drow, D[ 1].dcol, R[ 1].dval, R[ 1].drow, R[ 1].dcol,
                    D[ 2].dval, D[ 2].drow, D[ 2].dcol, R[ 2].dval, R[ 2].drow, R[ 2].dcol,
