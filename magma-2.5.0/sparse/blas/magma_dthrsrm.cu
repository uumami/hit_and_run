/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/magma_zthrsrm.cu, normal z -> d, Sun Sep 15 17:34:45 2019
       @author Hartwig Anzt
    ...
    magma_queue_t queue)
{
    ...
    magma_dget_row_ptr(A->num_rows, &B.nnz, new_rownnz, B.drow, queue); 
    magma_dmalloc(&B.dval,B.nnz);
