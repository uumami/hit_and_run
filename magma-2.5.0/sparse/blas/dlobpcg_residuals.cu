/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/zlobpcg_residuals.cu, normal z -> d, Sun Sep 15 17:33:00 2019
...
// copied from dnrm2.cu in trunk/magmablas
// ----------------------------------------
    ...
    magma_queue_t queue )
{
    ...
    magma_dlobpcg_res_kernel<<< grid, threads, 0, queue->cuda_stream() >>>
