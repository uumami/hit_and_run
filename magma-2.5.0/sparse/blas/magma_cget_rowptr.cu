/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/magma_zget_rowptr.cu, normal z -> c, Sun Sep 15 17:35:19 2019
    ...
    magma_queue_t queue)
{
    ...
    magma_cget_row_ptr_kernel<<<grid, block, 0, queue->cuda_stream()>>>
