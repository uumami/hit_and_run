/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/zparilu_kernels.cu, normal z -> d, Sun Sep 15 17:34:28 2019
    ...
    magma_queue_t queue)
{
    ...
    magma_dparilu_csr_kernel<<< grid, block, 0, queue->cuda_stream() >>>
