/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/blas/magma_zget_rowptr.cu, normal z -> d, Sun Sep 15 17:35:20 2019
    ...
    magma_queue_t queue)
{
    ...
    magma_dget_row_ptr_kernel<<<grid, block, 0, queue->cuda_stream()>>>
