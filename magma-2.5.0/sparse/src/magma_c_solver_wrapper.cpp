/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/magma_z_solver_wrapper.cpp, normal z -> c, Sun Sep 15 17:38:00 2019
       @author Hartwig Anzt
...
/**
    ...
    * ...
    ...
    magma_cutil_sparse.cpp for the possible options.
    ...
    magma_queue_t queue )
{
    ...
    if( b.num_cols == 1 ){
        switch( zopts->solver_par.solver ) {
            ...
            // case  Magma_PARDISO:
            //         CHECK( magma_cpardiso( A, b, x, &zopts->solver_par, queue ) ); break;
            default:
