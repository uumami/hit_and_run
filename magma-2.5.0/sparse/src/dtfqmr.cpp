/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/ztfqmr.cpp, normal z -> d, Sun Sep 15 17:37:05 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    // solver variables
    double nom0, r0,  res, nomb; //, normx, normd, normr_act;
    ...
    magma_dcopy( dofs, u_m.dval, 1, pu_m.dval, 1, queue );   
    ...
    do
    {
        ...
        tau = tau * theta *c;
        eta = c * c * alpha;
        // normd = magma_dnrm2( dofs, d.dval, 1, queue );
        // normx = magma_dnrm2( dofs, x->dval, 1, queue );
        // 
        // 
        // if ( MAGMA_D_ABS(eta)*normd < 1e-15*normx ){
        //     stag = stag + 1;
        // } else {
        //     stag = 0;
        // }
