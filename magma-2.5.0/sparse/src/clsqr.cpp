/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zlsqr.cpp, normal z -> c, Sun Sep 15 17:37:42 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_cvinit( &ut,Magma_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    ...
    do
    {
        ...
        CHECK( magma_c_spmv( c_one, A, z, c_zero, ut, queue ));
        magma_cscal( m, MAGMA_C_MAKE(-alpha, 0.0 ), u.dval, 1, queue ); 
        magma_caxpy( m, c_one, ut.dval, 1, u.dval, 1, queue );
