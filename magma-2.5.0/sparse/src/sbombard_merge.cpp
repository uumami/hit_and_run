/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zbombard_merge.cpp, normal z -> s, Sun Sep 15 17:37:38 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    magma_s_matrix r_tld={Magma_CSR};
    ...
    magma_s_matrix SpMV_in_1={Magma_CSR}, SpMV_out_1={Magma_CSR}, 
                    SpMV_in_2={Magma_CSR}, SpMV_out_2={Magma_CSR}; 
                    
    // workspace for zmsdot
    magma_s_matrix d1={Magma_CSR},  d2={Magma_CSR};
    ...
    CHECK( magma_svinit( &SpMV_in_1,  Magma_DEV, A.num_rows, b.num_cols * 4, c_zero, queue ));
    CHECK( magma_svinit( &SpMV_out_1, Magma_DEV, A.num_rows, b.num_cols * 4, c_zero, queue ));
    CHECK( magma_svinit( &SpMV_in_2,  Magma_DEV, A.num_rows, b.num_cols * 2, c_zero, queue ));
    CHECK( magma_svinit( &SpMV_out_2, Magma_DEV, A.num_rows, b.num_cols * 2, c_zero, queue ));
    ...
    do
    {
        ...
        // block SpMV
        CHECK( magma_s_spmv( c_one, A, SpMV_in_1, c_zero, SpMV_out_1, queue ));
        // QMR
        ...
        // BiCGSTAB
        //CHECK( magma_s_spmv( c_one, A, B_p, c_zero, B_v, queue )); 
        ...
        //   // block SpMV
           CHECK( magma_s_spmv( c_one, A, SpMV_in_2, c_zero, SpMV_out_2, queue ));
...
cleanup:
    ...
    magma_smfree(&SpMV_in_1,  queue );
    magma_smfree(&SpMV_out_1, queue );
    magma_smfree(&SpMV_in_2,  queue );
    magma_smfree(&SpMV_out_2, queue );
