/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zlsqr.cpp, normal z -> d, Sun Sep 15 17:37:42 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_dvinit( &zt,Magma_DEV, A.num_cols, b.num_cols, c_zero, queue ));
    ...
    CHECK( magma_dvinit( &ut,Magma_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    ...
    do
    {
        ...
        CHECK( magma_d_spmv( c_one, A, z, c_zero, ut, queue ));
        magma_dscal( m, MAGMA_D_MAKE(-alpha, 0.0 ), u.dval, 1, queue ); 
        magma_daxpy( m, c_one, ut.dval, 1, u.dval, 1, queue );
