/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zidr_merge.cpp, normal z -> s, Sun Sep 15 17:37:14 2019
*/
...
//---------------------------------------
        ...
        // t = A v
        // t = A r
        CHECK( magma_s_spmv( c_one, A, dr, c_zero, dt, queue ));
        solver_par->spmv_count++;
...
//---------------------------------------
        ...
        // x = x + om * v
        // x = x + om * r
        magma_saxpy( x->num_rows, om, dr.dval, 1, x->dval, 1, queue );
