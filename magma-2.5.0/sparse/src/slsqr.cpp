/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zlsqr.cpp, normal z -> s, Sun Sep 15 17:37:42 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_svinit( &zt,Magma_DEV, A.num_cols, b.num_cols, c_zero, queue ));
    ...
    CHECK( magma_svinit( &ut,Magma_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    ...
    do
    {
        ...
        CHECK( magma_s_spmv( c_one, A, z, c_zero, ut, queue ));
        magma_sscal( m, MAGMA_S_MAKE(-alpha, 0.0 ), u.dval, 1, queue ); 
        magma_saxpy( m, c_one, ut.dval, 1, u.dval, 1, queue );
