/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zresidualvec.cpp, normal z -> s, Sun Sep 15 17:38:01 2019
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    if ( A.num_rows == b.num_rows ) {
        ...
        magma_saxpy( dofs, one, b.dval, 1, r->dval, 1, queue );          // r = r - b
        *res =  magma_snrm2( dofs, r->dval, 1, queue );            // res = ||r||
        //               /magma_snrm2( dofs, b.dval, 1, queue );               /||b||
        ...
        for( magma_int_t i=0; i<num_vecs; i++) {
            magma_saxpy( dofs, one, b(i), 1, r(i), 1, queue );   // r = r - b
