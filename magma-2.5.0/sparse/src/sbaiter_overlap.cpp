/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zbaiter_overlap.cpp, normal z -> s, Sun Sep 15 17:37:22 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    magma_s_matrix Ah={Magma_CSR}, ACSR={Magma_CSR}, dA={Magma_CSR}, r={Magma_CSR},
    ...
    CHECK( magma_smtransfer( ACSR, &dA, Magma_CPU, Magma_DEV, queue ));
    
    CHECK( magma_svinit( &r, Magma_DEV, A.num_rows, b.num_cols, c_zero, queue ));
    CHECK(  magma_sresidualvec( dA, b, *x, &r, &residual, queue));
    ...
    CHECK(  magma_sresidual( dA, b, *x, &residual, queue));
