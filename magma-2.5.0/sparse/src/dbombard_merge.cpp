/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zbombard_merge.cpp, normal z -> d, Sun Sep 15 17:37:38 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    // solver variables
    double nom0, r0, res, Q_res, C_res, B_res, T_res, nomb;
    ...
    magma_d_matrix r_tld={Magma_CSR};
    ...
    magma_d_matrix SpMV_in_1={Magma_CSR}, SpMV_out_1={Magma_CSR}, 
                    SpMV_in_2={Magma_CSR}, SpMV_out_2={Magma_CSR}; 
                    
    // workspace for zmddot
    magma_d_matrix d1={Magma_CSR},  d2={Magma_CSR};
    ...
    CHECK( magma_dvinit( &SpMV_in_1,  Magma_DEV, A.num_rows, b.num_cols * 4, c_zero, queue ));
    CHECK( magma_dvinit( &SpMV_out_1, Magma_DEV, A.num_rows, b.num_cols * 4, c_zero, queue ));
    CHECK( magma_dvinit( &SpMV_in_2,  Magma_DEV, A.num_rows, b.num_cols * 2, c_zero, queue ));
    CHECK( magma_dvinit( &SpMV_out_2, Magma_DEV, A.num_rows, b.num_cols * 2, c_zero, queue ));
    ...
    do
    {
        ...
        // block SpMV
        CHECK( magma_d_spmv( c_one, A, SpMV_in_1, c_zero, SpMV_out_1, queue ));
        // QMR
        ...
        // BiCGSTAB
        //CHECK( magma_d_spmv( c_one, A, B_p, c_zero, B_v, queue )); 
        ...
        //   // block SpMV
           CHECK( magma_d_spmv( c_one, A, SpMV_in_2, c_zero, SpMV_out_2, queue ));
...
cleanup:
    ...
    magma_dmfree(&SpMV_in_1,  queue );
    magma_dmfree(&SpMV_out_1, queue );
    magma_dmfree(&SpMV_in_2,  queue );
    magma_dmfree(&SpMV_out_2, queue );
