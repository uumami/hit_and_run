/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zpbicg.cpp, normal z -> c, Sun Sep 15 17:36:59 2019
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    do
    {
        ...
        CHECK( magma_c_applyprecond_left( MagmaNoTrans, A, r, &y, precond_par, queue ));
        CHECK( magma_c_applyprecond_right( MagmaNoTrans, A, y, &z, precond_par, queue ));
        CHECK( magma_c_applyprecond_right( MagmaTrans, A, rt, &yt, precond_par, queue ));
        CHECK( magma_c_applyprecond_left( MagmaTrans, A, yt, &zt, precond_par, queue ));
        ...
        //magma_ccopy( dofs, yt.dval, 1 , zt.dval, 1, queue );           // yt=rt
