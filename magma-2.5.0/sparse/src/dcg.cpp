/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/src/zcg.cpp, normal z -> d, Sun Sep 15 17:36:52 2019
*/
    ...
    magma_queue_t queue )
{
    ...
    den = MAGMA_D_REAL( magma_ddot( dofs, p.dval, 1, q.dval, 1, queue ) ); // den = p dot q
    ...
    do
    {
        ...
        betanom = magma_dnrm2( dofs, r.dval, 1, queue );             // betanom = || r ||
        ...
        den = MAGMA_D_REAL(magma_ddot( dofs, p.dval, 1, q.dval, 1, queue) );
                // den = p dot q
        nom = betanomsq;
    }
