/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zmtransfer.cpp, normal z -> c, Sun Sep 15 17:36:26 2019
       @author Hartwig Anzt
*/
    ...
    magma_queue_t queue )
{
    ...
    if ( src == Magma_CPU && dst == Magma_DEV ) {
             ...
             A.storage_type == Magma_CSRU )
        {
            ...
            // data transfer
            magma_csetvector( A.nnz, A.val, 1, B->dval, 1, queue );
        ...
        //ELL/ELLPACKT-type
            ...
            // data transfer
            magma_csetvector( A.num_rows * A.max_nnz_row, A.val, 1, B->dval, 1, queue );
        ...
        //ELLRT-type
            ...
            // data transfer
            magma_csetvector( A.num_rows * rowlength, A.val, 1, B->dval, 1, queue );
        ...
        //CSR5-type
            ...
            CHECK( magma_cmalloc( &B->dcalibrator, A.csr5_p ));
            ...
            magma_csetvector( A.csr5_p, A.calibrator, 1, B->dcalibrator, 1, queue );
        ...
        //BCSR-type
            ...
            // data transfer
            magma_csetvector( size_b * size_b * A.numblocks, A.val, 1, B->dval, 1, queue );
        ...
        //DENSE-type
            ...
            // data transfer
            magma_csetvector( A.num_rows * A.num_cols, A.val, 1, B->dval, 1, queue );
        }
    }
    ...
    // second case: copy matrix from host to host
        ...
        //CSR5-type
            ...
            B->csr5_tail_tile_start = A.csr5_tail_tile_start;
            // memory allocation
            CHECK( magma_cmalloc_cpu( &B->dval, A.nnz ));
            ...
            CHECK( magma_cmalloc_cpu( &B->dcalibrator, A.csr5_p ));
        ...
        //BCSR-type
            ...
            magma_int_t r_blocks = magma_ceildiv( A.num_rows, size_b );
                    // max number of blocks per column
            // memory allocation
            CHECK( magma_cmalloc_cpu( &B->val, size_b * size_b * A.numblocks ));
    ...
    // third case: copy matrix from device to host
             ...
             A.storage_type == Magma_CSRU )
        {
            ...
            CHECK( magma_index_malloc_cpu( &B->col, A.nnz ));
            // data transfer
            magma_cgetvector( A.nnz, A.dval, 1, B->val, 1, queue );
        ...
        //ELL/ELLPACKT-type
            ...
            CHECK( magma_index_malloc_cpu( &B->col, A.num_rows * A.max_nnz_row ));
            // data transfer
            magma_cgetvector( A.num_rows * A.max_nnz_row, A.dval, 1, B->val, 1, queue );
        ...
        //ELLRT-type
            ...
            CHECK( magma_index_malloc_cpu( &B->col, rowlength * A.num_rows ));
            // data transfer
            magma_cgetvector( A.num_rows * rowlength, A.dval, 1, B->val, 1, queue );
        ...
        //CSR5-type
            ...
            CHECK( magma_index_malloc_cpu( &B->dtile_desc_offset, A.csr5_num_offsets ));
            // data transfer
            magma_cgetvector( A.nnz, A.val, 1, B->val, 1, queue );
            magma_index_getvector( A.num_rows + 1, A.drow, 1, B->row, 1, queue );
            magma_index_getvector( A.nnz, A.dcol, 1, B->col, 1, queue );
            ...
            magma_cgetvector( A.csr5_p, A.dcalibrator, 1, B->calibrator, 1, queue );
        ...
        //BCSR-type
            ...
            CHECK( magma_index_malloc_cpu( &B->col, A.numblocks ));
            // data transfer
            magma_cgetvector( size_b * size_b * A.numblocks, A.dval, 1, B->val, 1, queue );
        ...
        //DENSE-type
            ...
            CHECK( magma_cmalloc_cpu( &B->val, A.num_rows * A.num_cols ));
            // data transfer
            magma_cgetvector( A.num_rows * A.num_cols, A.dval, 1, B->val, 1, queue );
        }
    }
    ...
    // fourth case: copy matrix from device to device
        ...
        //ELL/ELLPACKT-type
            ...
            CHECK( magma_index_malloc( &B->dcol, A.num_rows * A.max_nnz_row ));
            // data transfer
            magma_ccopyvector( A.num_rows * A.max_nnz_row, A.dval, 1, B->dval, 1, queue );
        ...
        //ELLRT-type
            ...
            CHECK( magma_index_malloc( &B->drow, A.num_rows ));
            // data transfer
            magma_ccopyvector( A.num_rows * rowlength, A.dval, 1, B->dval, 1, queue );
        ...
        //CSR5-type
            ...
            magma_ccopyvector( A.csr5_p, A.dcalibrator, 1, B->dcalibrator, 1, queue );
        ...
        //BCSR-type
            ...
            CHECK( magma_index_malloc( &B->dcol, A.numblocks ));
            // data transfer
            magma_ccopyvector( size_b * size_b * A.numblocks, A.dval, 1, B->dval, 1, queue );
        ...
        //DENSE-type
            ...
            CHECK( magma_cmalloc( &B->dval, A.num_rows * A.num_cols ));
            // data transfer
            magma_ccopyvector( A.num_rows * A.num_cols, A.dval, 1, B->dval, 1, queue );
        }
    }
