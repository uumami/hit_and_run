/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zmtransfer.cpp, normal z -> d, Sun Sep 15 17:36:25 2019
       @author Hartwig Anzt
*/
    ...
    magma_queue_t queue )
{
    ...
    if ( src == Magma_CPU && dst == Magma_DEV ) {
        ...
        //CSR5-type
            ...
            CHECK( magma_dmalloc( &B->dcalibrator, A.csr5_p ));
            ...
            magma_dsetvector( A.csr5_p, A.calibrator, 1, B->dcalibrator, 1, queue );
    ...
    // second case: copy matrix from host to host
        ...
        //CSR5-type
            ...
            B->csr5_tail_tile_start = A.csr5_tail_tile_start;
            // memory allocation
            CHECK( magma_dmalloc_cpu( &B->dval, A.nnz ));
            ...
            CHECK( magma_dmalloc_cpu( &B->dcalibrator, A.csr5_p ));
    ...
    // third case: copy matrix from device to host
        ...
        //CSR5-type
            ...
            CHECK( magma_index_malloc_cpu( &B->dtile_desc_offset, A.csr5_num_offsets ));
            // data transfer
            magma_dgetvector( A.nnz, A.val, 1, B->val, 1, queue );
            magma_index_getvector( A.num_rows + 1, A.drow, 1, B->row, 1, queue );
            magma_index_getvector( A.nnz, A.dcol, 1, B->col, 1, queue );
            ...
            magma_dgetvector( A.csr5_p, A.dcalibrator, 1, B->calibrator, 1, queue );
    ...
    // fourth case: copy matrix from device to device
        ...
        //CSR5-type
            ...
            magma_dcopyvector( A.csr5_p, A.dcalibrator, 1, B->dcalibrator, 1, queue );
