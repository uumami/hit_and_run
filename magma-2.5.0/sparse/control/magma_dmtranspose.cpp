/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zmtranspose.cpp, normal z -> d, Sun Sep 15 17:36:23 2019
       @author Hartwig Anzt
       @author Mark Gates
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_dmalloc_cpu( &csc_values, nnz ) );
    ...
    magma_queue_t queue )
{
    ...
    if( A.memory_location == Magma_DEV ){
        ...
        CHECK( magma_dmtranspose_cpu(A, B, queue) );
    }
    ...
    magma_queue_t queue )
{
    ...
    magma_d_matrix ACSR={Magma_CSR}, BCSR={Magma_CSR};
    ...
    if( A.storage_type == Magma_CSR && A.memory_location == Magma_DEV ) {
        ...
        CHECK( magma_dmtransfer( dB, B, Magma_DEV, A.memory_location, queue ));
    } else {
        CHECK( magma_dmconvert( A, &ACSR, A.storage_type, Magma_CSR, queue ));
        CHECK( magma_d_cucsrtranspose( ACSR, &BCSR, queue ));
        CHECK( magma_dmconvert( BCSR, B, Magma_CSR, A.storage_type, queue ));
    }
cleanup:
    ...
    magma_queue_t queue )
{
    ...
    if( A.storage_type == Magma_CSR && A.memory_location == Magma_DEV ) {
        ...
        CHECK( magma_dmtransfer( A, &dA, A.memory_location, Magma_DEV, queue ));
        CHECK( magma_dmtransposeconjugate( dA, &dB, queue ));
        CHECK( magma_dmtransfer( dB, B, Magma_DEV, A.memory_location, queue ));
    } else {
        CHECK( magma_dmconvert( A, &ACSR, A.storage_type, Magma_CSR, queue ));
        CHECK( magma_dmtransposeconjugate( ACSR, &BCSR, queue ));
        CHECK( magma_dmconvert( BCSR, B, Magma_CSR, A.storage_type, queue ));
    }
cleanup:
    cusparseDestroyMatDescr( descrA );
