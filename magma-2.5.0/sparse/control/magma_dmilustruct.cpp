/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zmilustruct.cpp, normal z -> d, Sun Sep 15 17:36:27 2019
       @author Hartwig Anzt
*/
...
void magma_dmexFunction(magma_int_t nlhs, magma_int_t n, double omega,
                 magma_int_t levfill, magma_int_t storage,
                magma_index_t * ial, magma_index_t *jal, double *al,
                magma_index_t * iau, magma_index_t *jau, double *au,
                magma_int_t nrhs,
                magma_index_t * ia, magma_index_t *ja, double *a )
{
    ...
    magma_dsymbolic_ilu(levfill, n, &nzl, &nzu, ia, ja, ial, jal, iau, jau);
}
