/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zmsupernodal.cpp, normal z -> s, Sun Sep 15 17:36:36 2019
       @author Hartwig Anzt
...
//     magma_svread( &x, nlength, filename, queue );
// for( int z=0; z< nlength; z++){
//     blocksizes2[z] = (magma_int_t) MAGMA_S_REAL((x.val[z]));  
// }
// blockcount2 = nlength;
