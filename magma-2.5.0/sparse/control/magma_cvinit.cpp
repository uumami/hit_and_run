/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from sparse/control/magma_zvinit.cpp, normal z -> c, Sun Sep 15 17:36:31 2019
       @author Hartwig Anzt
*/
    ...
    magma_queue_t queue )
{
    ...
    if ( mem_loc == Magma_CPU ) {
        ...
        CHECK( magma_cvinit_rand( &x_h, Magma_CPU, num_rows, num_cols, queue ));
        CHECK( magma_cmtransfer( x_h, x, Magma_CPU, Magma_DEV, queue ) );
    }
