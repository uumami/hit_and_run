...
*/
static __device__
void slacpy_sym_in_full_device(
    int m, int n,
...
*/
static __device__
void slacpy_sym_in_lower_device(
...
*/
static __device__
void slacpy_sym_in_upper_device(
    int m, int n,
    const float *dA, int ldda,
    float       *dB, int lddb )
{
...
*/
__global__
void slacpy_sym_in_full_kernel(
    int m, int n,
    const float *dA, int ldda,
    float       *dB, int lddb )
{
    slacpy_sym_in_full_device(m, n, dA, ldda, dB, lddb);
}

__global__
void slacpy_sym_in_lower_kernel(
    int m, int n, magma_int_t *rows, magma_int_t *perm,
    const float *dA, int ldda,
    float       *dB, int lddb )
{
    slacpy_sym_in_lower_device(m, n, rows, perm, dA, ldda, dB, lddb);
}

__global__
void slacpy_sym_in_upper_kernel(
    int m, int n,
    const float *dA, int ldda,
    float       *dB, int lddb )
{
    slacpy_sym_in_upper_device(m, n, dA, ldda, dB, lddb);
}
...
/***************************************************************************//**
    Purpose
    -------
    SLACPY_SYM_IN copies all or part of a two-dimensional matrix dA to another
    matrix dB.
