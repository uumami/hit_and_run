/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/ztrmm_vbatched_core.cu, normal z -> s, Sun Sep 15 17:25:21 2019
...
magma_int_t magma_get_strmm_vbatched_nb(magma_int_t n)
{
...
/******************************************************************************/
void
magmablas_strmm_small_vbatched(
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    {
        case 0: // lNx
            trmm_template_vbatched_lNx<float, STRMM_BATCHED_NB>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        case 1: // lTx
            trmm_template_vbatched_lTx<float, STRMM_BATCHED_NB, 0>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        case 2: // lCx
            trmm_template_vbatched_lTx<float, STRMM_BATCHED_NB, 1>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        case 3: // rNx
            trmm_template_vbatched_rNx<float, STRMM_BATCHED_NB>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        case 4: // rTx
            trmm_template_vbatched_rTx<float, STRMM_BATCHED_NB, 0>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        case 5: // rCx
            trmm_template_vbatched_rTx<float, STRMM_BATCHED_NB, 1>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue);
            break;
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    // stopping condition
    if(max_nrowA <= STRMM_BATCHED_NB){
        magmablas_strmm_small_vbatched( side, uplo, transA, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, max_m, max_n, roffA, coffA, roffB, coffB, spec_m, spec_n, batchCount, queue );
    ...
    // at this point we can say that max_nrowA > STRMM_BATCHED_NB
    switch(shape)
    {
        case 0: // lNl
            {
                const int m1 = magma_get_strmm_vbatched_nb(max_m); 
        ...
        case 1: // lNU
            {
                const int m2 = magma_get_strmm_vbatched_nb(max_m); 
        ...
        case 4: // rNL
            {
                const int n2 = magma_get_strmm_vbatched_nb(max_n); 
        ...
        case 5: // rNU
            {
                const int n1 = magma_get_strmm_vbatched_nb(max_n); 
