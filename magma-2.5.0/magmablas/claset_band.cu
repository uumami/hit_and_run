/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zlaset_band.cu, normal z -> c, Sun Sep 15 17:17:31 2019
    ...
    magma_queue_t queue)
{
    ...
    if (uplo == MagmaUpper) {
        ...
        claset_band_upper<<< grid, threads, 0, queue->cuda_stream() >>> (m, n, offdiag, diag, dA, ldda);
    }
