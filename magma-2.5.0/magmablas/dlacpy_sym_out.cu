/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zlacpy_sym_out.cu, normal z -> d, Sun Sep 15 17:16:30 2019
...
/***************************************************************************//**
    Purpose
    -------
    DLACPY_SYM_OUT copies all or part of a two-dimensional matrix dA to another
    matrix dB.
