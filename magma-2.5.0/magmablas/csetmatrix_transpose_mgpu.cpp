/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zsetmatrix_transpose_mgpu.cpp, normal z -> c, Sun Sep 15 17:19:13 2019
...
#define dAT(d, j)   (dAT[(d)]   + (j)*nb)
    ...
    for (j=0; j < n; j += nb) {
        ...
        magmablas_ctranspose( m, ib, dwork(d,id), lddw, dAT(d,j_local), ldda, queues[d][id] );
    }
}
