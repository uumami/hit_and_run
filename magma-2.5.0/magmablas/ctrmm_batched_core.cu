/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/ztrmm_batched_core.cu, normal z -> c, Sun Sep 15 17:23:56 2019
...
magma_int_t magma_get_ctrmm_batched_nb(magma_int_t n)
{
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    {
        case 0: // lNx
            trmm_template_batched_lNx<magmaFloatComplex, CTRMM_BATCHED_NB>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
        case 1: // lTx
            trmm_template_batched_lTx<magmaFloatComplex, CTRMM_BATCHED_NB, 0>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
        case 2: // lCx
            trmm_template_batched_lTx<magmaFloatComplex, CTRMM_BATCHED_NB, 1>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
        case 3: // rNx
            trmm_template_batched_rNx<magmaFloatComplex, CTRMM_BATCHED_NB>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
        case 4: // rTx
            trmm_template_batched_rTx<magmaFloatComplex, CTRMM_BATCHED_NB, 0>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
        case 5: // rCx
            trmm_template_batched_rTx<magmaFloatComplex, CTRMM_BATCHED_NB, 1>
            (uplo, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, Ai, Aj, Bi, Bj, batchCount, queue);
            break;
...
#define dB_array(i,j) dB_array, i, j
    ...
    // at this point we can tell that nrowA > CTRMM_BATCHED_NB
    switch(shape)
    {
        case 0: // lNl
            {
                const int m1 = magma_get_ctrmm_batched_nb(m); 
                const int m2 = m - m1;
        ...
        case 1: // lNU
            {
                const int m2 = magma_get_ctrmm_batched_nb(m); 
                const int m1 = m - m2;
        ...
        case 4: // rNL
            {
                const int n2 = magma_get_ctrmm_batched_nb(n); 
                const int n1 = n - n2;
        ...
        case 5: // rNU
            {
                const int n1 = magma_get_ctrmm_batched_nb(n); 
                const int n2 = n - n1;
