/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zgetmatrix_transpose.cpp, normal z -> c, Sun Sep 15 17:16:09 2019
...
#define dwork(i_, j_) (dwork + (i_) + (j_)*lddw)
    ...
    for (i=0; i < n; i += nb) {
        ...
        magmablas_ctranspose( ib, m, dAT(i,0), ldda, dwork(0,(j%2)*nb), lddw, queues[j%2] );
