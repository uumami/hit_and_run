/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zlaset_band.cu, normal z -> d, Sun Sep 15 17:17:30 2019
...
/***************************************************************************//**
    Purpose
    -------
    DLASET_BAND initializes the main diagonal of dA to DIAG,
    ...
    magma_queue_t queue)
{
    ...
    if (uplo == MagmaUpper) {
        ...
        dlaset_band_upper<<< grid, threads, 0, queue->cuda_stream() >>> (m, n, offdiag, diag, dA, ldda);
    }
