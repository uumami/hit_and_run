/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/ztrsm_batched_core.cpp, normal z -> d, Sun Sep 15 17:23:59 2019
...
#define PRECISION_d
magma_int_t magma_get_dtrsm_batched_nb(magma_int_t n)
{
...
#define dB_array(i,j) dB_array, i, j
    ...
    const double c_negone = MAGMA_D_NEG_ONE; 
    ...
    magma_int_t batrsm_stop_nb = magma_get_dtrsm_batched_stop_nb(side, m, n);
    // stopping condition
    ...
    switch(shape)
    {
        case 0: // lNl
            {
                const int m2 = magma_get_dtrsm_batched_nb(m); 
                const int m1 = m - m2;
        ...
        case 3: // lTU | lCU
            {
                const int m1 = magma_get_dtrsm_batched_nb(m); 
                const int m2 = m - m1;
        ...
        case 4: // rNL
             {
                const int n2 = magma_get_dtrsm_batched_nb(n); 
                const int n1 = n - n2;
        ...
        case 5: // rNU
            {
                const int n1 = magma_get_dtrsm_batched_nb(n); 
                const int n2 = n - n1;
