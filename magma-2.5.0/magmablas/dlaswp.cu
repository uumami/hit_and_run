/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zlaswp.cu, normal z -> d, Sun Sep 15 17:17:33 2019
...
/***************************************************************************//**
    ...
    ** Unlike LAPACK, here A is stored row-wise (hence dAT). **
    ...
    @param[in,out]
    dAT      DOUBLE PRECISION array on GPU, stored row-wise, dimension (LDDA,*)
             On entry, the matrix of column dimension N to which the row
             interchanges will be applied.
             On exit, the permuted matrix.
