/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/ztranspose.cu, normal z -> s, Sun Sep 15 17:18:02 2019
...
__global__
void stranspose_kernel_batched_stride(
    ...
    magma_queue_t queue )
{
    ...
    dim3 threads( NX, NY, 1 );
    dim3 grid( magma_ceildiv( m, NB ), magma_ceildiv( n, NB ), batchCount );
    //stranspose_kernel_batched_stride<<< grid, threads, 0, queue->cuda_stream() >>>
    stranspose_kernel_batched_stride<<< grid, threads>>>
