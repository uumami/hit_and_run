/*
   ...
   @generated from magmablas/zpotf2_kernels_var.cu, normal z -> c, Sun Sep 15 17:25:42 2019
 */
#define PRECISION_c
        ...
        int localstep, int gbstep, magma_int_t *info_array)
{
    ...
    if(myib == POTF2_NB)
        ...
        cpotf2_smlpout_anywidth_device( myrows, myib, dA_array[batchid]+localstep, dA_array[batchid]+localstep+localstep*mylda, mylda, localstep, gbstep, &(info_array[batchid]));
}
/////////////////////////////////////////////////////////////////////////////////////////////////
