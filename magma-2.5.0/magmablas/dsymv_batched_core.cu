/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zhemv_batched_core.cu, normal z -> d, Sun Sep 15 17:20:16 2019
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    if(uplo == MagmaLower){
        ...
        hemv_diag_template_batched<double, DSYMV_BATCHED_LOWER>
                ( uplo, n, 
                  alpha, dA_array, ldda, 
                         dX_array, incx, 
                  beta,  dY_array, incy, 
        ...
        if(n > nb){
            hemv_lower_template_batched<double, DSYMV_BATCHED_LOWER>
                ( n, alpha, 
                  dA_array, ldda, 
                  dX_array, incx, 
                  dY_array, incy, 
        ...
        const int nb = param[0];
        hemv_diag_template_batched<double, DSYMV_BATCHED_UPPER>
                ( uplo, n, 
                  alpha, dA_array, ldda, 
                         dX_array, incx, 
                  beta,  dY_array, incy, 
                  offA, offX, offY, batchCount, queue);
        if(n > nb){
            hemv_upper_template_batched<double, DSYMV_BATCHED_UPPER>
                ( n, alpha, 
                  dA_array, ldda, 
                  dX_array, incx, 
                  dY_array, incy, 
