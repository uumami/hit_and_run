/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zhemm_batched_core.cu, normal z -> d, Sun Sep 15 17:23:32 2019
...
{
    if(side == MagmaLeft){
        hemm_template_batched<double, DSYMM_BATCHED_LEFT>(
            side, uplo, m, n, 
            dA_array, ldda,
            dB_array, lddb, 
        ...
        hemm_template_batched<double, DSYMM_BATCHED_RIGHT>(
            side, uplo, m, n, 
            dA_array, ldda,
            dB_array, lddb, 
            dC_array, lddc, alpha, beta, 
