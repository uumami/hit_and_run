/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from magmablas/zhemv_vbatched_core.cu, normal z -> s, Sun Sep 15 17:25:18 2019
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    if(uplo == MagmaLower){
        ...
        hemv_diag_template_vbatched<float, SSYMV_BATCHED_LOWER>
                ( uplo, n, 
                  alpha, dA_array, ldda, 
                         dX_array, incx, 
                  beta,  dY_array, incy, 
        ...
        if(max_n > nb){
            hemv_lower_template_vbatched<float, SSYMV_BATCHED_LOWER>
                ( n, alpha, 
                  dA_array, ldda, 
                  dX_array, incx, 
                  dY_array, incy, 
        ...
        const int nb = param[0];
        hemv_diag_template_vbatched<float, SSYMV_BATCHED_UPPER>
                ( uplo, n, 
                  alpha, dA_array, ldda, 
                         dX_array, incx, 
                  beta,  dY_array, incy, 
                  max_n, offA, offX, offY, spec_n, batchCount, queue);
        if(max_n > nb){
            hemv_upper_template_vbatched<float, SSYMV_BATCHED_UPPER>
                ( n, alpha, 
                  dA_array, ldda, 
                  dX_array, incx, 
                  dY_array, incy, 
