...
/////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void spotf2_smlpout_kernel_vbatched_v2(int maxm, magma_int_t *m, 
        ...
        int localstep, int gbstep, magma_int_t *info_array)
{
    ...
    if(myib == POTF2_NB)
        spotf2_smlpout_fixwidth_device( myrows, dA_array[batchid]+mylocstep, dA_array[batchid]+mylocstep+mylocstep*mylda, mylda, mylocstep, gbstep, &(info_array[batchid]));
    else
        spotf2_smlpout_anywidth_device( myrows, myib, dA_array[batchid]+mylocstep, dA_array[batchid]+mylocstep+mylocstep*mylda, mylda, mylocstep, gbstep, &(info_array[batchid]));
}
/////////////////////////////////////////////////////////////////////////////////////////////////
__global__ void spotf2_smlpout_kernel_vbatched(magma_int_t *m, 
        float **dA_array, magma_int_t *lda, 
        int localstep, int gbstep, magma_int_t *info_array)
{
    const int batchid = blockIdx.z;
    ...
    if(myib == POTF2_NB)
        spotf2_smlpout_fixwidth_device( myrows, dA_array[batchid]+localstep, dA_array[batchid]+localstep+localstep*mylda, mylda, localstep, gbstep, &(info_array[batchid]));
    else
        spotf2_smlpout_anywidth_device( myrows, myib, dA_array[batchid]+localstep, dA_array[batchid]+localstep+localstep*mylda, mylda, localstep, gbstep, &(info_array[batchid]));
}
/////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue)
{
    ...
    for(magma_int_t j = 0; j < max_n; j+= POTF2_NB) {
        ...
        //spotf2_smlpout_kernel_vbatched<<<dimGrid, threads, shared_mem_size, queue >>>(n, dA_array, lda, j, gbstep, info_array);
        spotf2_smlpout_kernel_vbatched_v2
