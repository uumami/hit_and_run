/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zhetrd_gpu.cpp, normal z -> d, Sun Sep 15 17:30:04 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 1) {
                magma_dsytrd_gpu( opts.uplo, N, d_R, ldda, diag, offdiag,
                                  tau, h_R, lda, h_work, lwork, &info );
            }
            else {
                magma_dsytrd2_gpu( opts.uplo, N, d_R, ldda, diag, offdiag,
            ...
            if ( opts.check ) {
                ...
                magma_dgetmatrix( N, N, d_R, ldda, h_Q, lda, opts.queue );
