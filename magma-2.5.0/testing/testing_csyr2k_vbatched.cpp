/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zsyr2k_vbatched.cpp, normal z -> c, Sun Sep 15 17:31:38 2019
       @author Mark Gates
       @author Azzam Haidar
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            #if 0
            magmablas_csyr2k_vbatched_max_nocheck(opts.uplo, opts.transA, d_N, d_K,
                             alpha, d_A_array, d_ldda,
                                    d_B_array, d_lddb,
                             beta, d_C_array, d_lddc,
                             batchCount, max_N, max_K, opts.queue );
            #else
            magmablas_csyr2k_vbatched(opts.uplo, opts.transA, d_N, d_K,
                             alpha, d_A_array, d_ldda,
                                    d_B_array, d_lddb,
                             beta, d_C_array, d_lddc,
