/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zsymmetrize_tiles.cpp, normal z -> d, Sun Sep 15 17:28:15 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_dsymmetrize_tiles( opts.uplo, nb, d_A, ldda, ntile, mstride, nstride, opts.queue );
            ...
            for( tile = 0; tile < ntile; ++tile ) {
                ...
                for( j = 0; j < nb; ++j ) {
                    ...
                    // real diagonal
                    h_A[offset + j + j*lda] = MAGMA_D_MAKE( MAGMA_D_REAL( h_A[offset + j + j*lda] ), 0 );
                }
            }
