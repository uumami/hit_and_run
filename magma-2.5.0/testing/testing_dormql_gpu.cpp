/*
    -- MAGMA (version 2.5.0) --
       ...
       @author Mark Gates
       @generated from testing/testing_zunmql_gpu.cpp, normal z -> d, Sun Sep 15 17:29:33 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int itran = 0; itran < 2; ++itran ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (info != 0)
                printf("lapackf77_dormql returned error %lld: %s.\n",
                       (long long) info, magma_strerror( info ));
            ...
            //if (info != 0)
            //    printf("magma_dormql (lwork query) returned error %lld: %s.\n",
            //           (long long) info, magma_strerror( info ));
            ...
            if (info != 0)
                printf("magma_dormql returned error %lld: %s.\n",
                       (long long) info, magma_strerror( info ));
