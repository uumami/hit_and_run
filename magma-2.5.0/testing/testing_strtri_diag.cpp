/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_ztrtri_diag.cpp, normal z -> s, Sun Sep 15 17:28:23 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_CHECK( magma_smalloc( &d_dinvA, size_inv ));
            TESTING_CHECK( magma_smalloc_cpu( &h_dinvA, size_inv ));
