/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zher2k_batched.cpp, normal z -> c, Sun Sep 15 17:30:52 2019
       @author Mark Gates
       @author Azzam Haidar
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_cher2k_batched(opts.uplo, opts.transA, N, K, 
