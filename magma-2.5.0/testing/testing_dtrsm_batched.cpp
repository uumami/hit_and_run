/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_ztrsm_batched.cpp, normal z -> d, Sun Sep 15 17:31:00 2019
...
int main( int argc, char** argv)
{
    ...
    double          error, magma_error, cublas_error, lapack_error, work[1];
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_CHECK( magma_dmalloc( &dinvA, dinvA_batchSize * batchCount ));
