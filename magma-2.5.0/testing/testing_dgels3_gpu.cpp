/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zgels3_gpu.cpp, normal z -> d, Sun Sep 15 17:29:18 2019
...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_A2, *h_B, *h_X, *h_R, *tau, *h_work, tmp[1], unused[1];
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lhwork = -1;
            lapackf77_dgeqrf( &M, &N, unused, &M, unused, tmp, &lhwork, &info );
            ...
            if (info != 0) {
                printf("magma_dgels3_gpu returned error %lld: %s.\n",
