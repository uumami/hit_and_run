/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zgetrf_mgpu.cpp, normal z -> d, Sun Sep 15 17:29:03 2019
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            for( int dev=0; dev < ngpu; dev++ ) {
                ...
                magma_setdevice( dev );
                TESTING_CHECK( magma_dmalloc( &d_lA[dev], ldda*ldn_local ));
            }
            ...
            /* ====================================================================
               ...
               =================================================================== */
            init_matrix( opts, M, N, h_A, lda );
            magma_dsetmatrix_1D_col_bcyclic( ngpu, M, N, nb, h_A, lda, d_lA, ldda, queues );
            ...
            if (info != 0) {
                printf("magma_dgetrf_mgpu returned error %lld: %s.\n",
                       (long long) info, magma_strerror( info ));
            }
                       
            magma_dgetmatrix_1D_col_bcyclic( ngpu, M, N, nb, d_lA, ldda, h_A, lda, queues );
