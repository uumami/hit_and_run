/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zhetrf.cpp, normal z -> d, Sun Sep 15 17:28:52 2019
    ...
    magma_int_t *ipiv)
{
    ...
    // compute norm of A
    matnorm = lapackf77_dlansy( "Fro", lapack_uplo_const(uplo), &N, A, &lda, work);
    ...
    residual = lapackf77_dlange( "Fro", &N, &N, D, &N, work);
    ...
    magma_int_t *ipiv)
{
    ...
    */
    ...
    residual = lapackf77_dlange( "Fro", &N, &N, T, &N, work);
