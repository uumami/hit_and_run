/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zherk_batched.cpp, normal z -> s, Sun Sep 15 17:30:52 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sset_pointer( d_A_array, d_A, lda, 0, 0, ldda*Ak, batchCount, opts.queue );
            magma_sset_pointer( d_C_array, d_C, ldc, 0, 0, lddc*N,  batchCount, opts.queue );
