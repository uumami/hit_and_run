/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zgesvd.cpp, normal z -> s, Sun Sep 15 17:30:33 2019
       @author Mark Gates
    ...
    std::string& path_str )
{
    ...
    #ifdef COMPLEX
        /* =====================================================================
           lwork formulas for sgesvd (Complex)
           =================================================================== */
...
/* ////////////////////////////////////////////////////////////////////////////
   -- Testing sgesvd (SVD with QR iteration)
      ...
      for( auto jobv = opts.jobv.begin(); jobv != opts.jobv.end(); ++jobv ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.verbose) {
                ...
                printf( "S = " );  magma_sprint( 1, min_mn, Sref, 1 );
            }
            ...
            if ( opts.magma ) {
                ...
                if (opts.verbose) {
                    printf( "Smagma = " );  magma_sprint( 1, min_mn, S, 1 );
                }
            }
            ...
            if ( opts.lapack ) {
                ...
                const char *func = "lapackf77_sgesvd";
                if ( *svd_work == MagmaSVD_min_1 ) {
                    if (info == -13) {
                        printf( "ok: with lwork = min-1 = %lld, %s returned expected info = %lld\n",
                                (long long) lwork_magma.value, func, (long long) info );
                ...
                if (opts.verbose) {
                    printf( "Slapack = " );  magma_sprint( 1, min_mn, Sref, 1 );
                }
