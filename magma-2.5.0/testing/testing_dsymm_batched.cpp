/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zhemm_batched.cpp, normal z -> d, Sun Sep 15 17:30:47 2019
*/
...
int main( int argc, char** argv)
{
    ...
    double **h_A_array = NULL, **h_B_array = NULL, **h_C_array = NULL;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                blas_dsymm_batched( opts.side, opts.uplo, 
                    M, N, 
                    alpha, h_A_array, lda, 
                           h_B_array, ldb, 
