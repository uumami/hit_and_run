/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zheevd.cpp, normal z -> s, Sun Sep 15 17:30:07 2019
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 1) {
                ...
                if (opts.ngpu == 1) {
                    ...
                    //printf( "magma_ssyevdx_m, ngpu %lld (%lld)\n", (long long) opts.ngpu, (long long) abs_ngpu );
            ...
            if (info != 0) {
                printf("magma_ssyevd returned error %lld: %s.\n",
