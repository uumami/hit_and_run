/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zlaset.cpp, normal z -> c, Sun Sep 15 17:28:05 2019
       @author Mark Gates
*/
      ...
      for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
          for( int ival = 0; ival < 4; ++ival ) {
            ...
            //magmablas_claset( uplo[iuplo], M-2, N-2, offdiag, diag, d_A+1+ldda, ldda, opts.queue );  // inset by 1 row & col
            magmablas_claset( uplo[iuplo], M, N, offdiag, diag, d_A, ldda, opts.queue );
