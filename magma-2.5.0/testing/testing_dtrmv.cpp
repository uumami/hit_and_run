/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_ztrmv.cpp, normal z -> d, Sun Sep 15 17:27:35 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // for error checks
            double Anorm = lapackf77_dlange( "F", &N, &N,    hA, &lda, work );
            double Xnorm = lapackf77_dlange( "F", &N, &ione, hx, &N,   work );
            ...
            if ( opts.lapack ) {
                ...
                dev_error = lapackf77_dlange( "F", &N, &ione, hxdev, &N, work )
