/*
    -- MAGMA (version 2.5.0) --
       ...
       @generated from testing/testing_zgesv_rbt.cpp, normal z -> d, Sun Sep 15 17:29:07 2019
       @author Mark Gates
*/
// includes, system
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_CHECK( magma_dmalloc_cpu( &h_LU, lda*N    ));
            ...
            magma_dgesv_rbt(MagmaTrue, N, nrhs, h_LU, lda, h_X, ldb, &info );
            gpu_time = magma_wtime() - gpu_time;
            gpu_perf = gflops / gpu_time;
            if (info != 0) {
                printf("magma_dgesv_rbt returned error %lld: %s.\n",
